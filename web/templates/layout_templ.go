...
func Layout(data LayoutData) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 2, " - SocGo</title><script src=\"https://cdn.tailwindcss.com\"></script><link rel=\"stylesheet\" href=\"/static/css/app.css?v=1\"><link rel=\"stylesheet\" href=\"/static/css/post-sidebar.css?v=1\"><link rel=\"stylesheet\" href=\"/static/css/calendar.css?v=1\"><noscript><style>\n\t\t\t\t\t.js-only { display: none !important; }\n\t\t\t\t\t.htmx-indicator { display: none !important; }\n\t\t\t\t</style></noscript></head><body class=\"bg-gray-100 min-h-screen\" style=\"overflow-x: hidden;\"><script>\n\t\t\t\t// Remove no-js class if JavaScript is enabled\n\t\t\t\tdocument.documentElement.classList.remove('no-js');\n\t\t\t</script>")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		...
		if data.FlashMessage != "" {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `web/templates/layout.templ`, Line: 41, Col: 25}
			}
